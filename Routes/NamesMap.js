...
export const Names = {
  ...
  "екстрена-психологічна-допомога": {
    name: "Екстрена психологічна допомога",
    component: EkstrennaDopomoga,
  },
  "екстрена-психологічна-допомога/страх": {
    name: "Екстрена психологічна допомога/Страх",
    component: Strah,
  },
  "екстрена-психологічна-допомога/істерика": {
    name: "Екстрена психологічна допомога/Істерика",
    component: Isteryka,
  },
  "екстрена-психологічна-допомога/плач": {
    name: "Екстрена психологічна допомога/Плач",
    component: Plach,
  },
  "екстрена-психологічна-допомога/ступор": {
    name: "Екстрена психологічна допомога/Ступор",
    component: Stupor,
  },
  "екстрена-психологічна-допомога/нервове-тремтіння": {
    name: "Екстрена психологічна допомога/Нервове Тремтіння",
    component: NervoveTremtinnya,
  },
  "екстрена-психологічна-допомога/агресія": {
    name: "Екстрена психологічна допомога/Агресія",
    component: Agresiya,
  },
  "екстрена-психологічна-допомога/марення-і-галюцинації": {
    name: "Екстрена психологічна допомога/Марення і галюцинації",
    component: Marennya,
  },
  "екстрена-психологічна-допомога/перезбудження": {
    name: "Екстрена психологічна допомога/Перезбудження",
    component: Perezbudzennya,
  },
  "дорослим": {
    name: "Дорослим",
    component: Doroslym,
  },
  "дорослим/антистресова-активність": {
    name: "Дорослим/Антистресова активність",
    component: Antistresova,
  },
  "дорослим/щоденна-турбота-про-себе": {
    name: "Дорослим/Щоденна турбота про себе",
    component: Shodenna,
  },
  "дорослим/техніки-самодопомоги-тут-і-зараз": {
    name: "Дорослим/Техніки самодопомоги тут і зараз",
    component: Techniky,
  },
  "дорослим/щоденна-турбота-про-себе/швидкий-рецепт-психологічної-стійкості": {
    name: "Дорослим/Щоденна турбота про себе/Швидкий рецепт психологічної стійкості",
    component: Shvydkiy,
  },
  "дорослим/щоденна-турбота-про-себе/вправа-«внутрішній-сад»": {
    name: "Дорослим/Щоденна турбота про себе/Вправа «Внутрішній сад»",
    component: VnutrishnySad,
  },
  "дорослим/щоденна-турбота-про-себе/вправа-«спокійне-місце»": {
    name: "Дорослим/Щоденна турбота про себе/Вправа «Спокійне місце»",
    component: Spokiyne,
  },
  "дорослим/щоденна-турбота-про-себе/вправа-«внутрішній-сейф»": {
    name: "Дорослим/Щоденна турбота про себе/Вправа «Внутрішній сейф»",
    component: VnutrishnySeif,
  },
  "дорослим/щоденна-турбота-про-себе/вправа-«чорно-біла-фотографія»": {
    name: "Дорослим/Щоденна турбота про себе/Вправа «Чорно-біла фотографія»",
    component: ChornoBileFoto,
  },
  "дорослим/щоденна-турбота-про-себе/вправа-«чорно-білий-кадр»": {
    name: "Дорослим/Щоденна турбота про себе/Вправа «Чорно-білий кадр»",
    component: ChornoBilyCadr,
  },
  "дорослим/щоденна-турбота-про-себе/техніка-самостійних-обіймів": {
    name: "Дорослим/Щоденна турбота про себе/Техніка самостійних обіймів",
    component: Tehnika,
  },
  "дорослим/щоденна-турбота-про-себе/вправа-«квітка-самопочуття»": {
    name: "Дорослим/Щоденна турбота про себе/Вправа «Квітка самопочуття»",
    component: Kvitka,
  },
  "дорослим/щоденна-турбота-про-себе/вправа-«я-маю,-я-є,-я-можу-і-я-буду»": {
    name: "Дорослим/Щоденна турбота про себе/Вправа «Я маю, я є, я можу і я буду»",
    component: YaMaiu,
  },
  "дорослим/антистресова-активність/тілесні-вправи": {
    name: "Дорослим/Антистресова активність/Тілесні вправи",
    component: Tilesni,
  },
  "дорослим/антистресова-активність/релаксаційні-вправи": {
    name: "Дорослим/Антистресова активність/Релаксаційні вправи",
    component: Relaksaciini,
  },
  "дорослим/антистресова-активність/когнітивні-вправи": {
    name: "Дорослим/Антистресова активність/Когнітивні вправи",
    component: Kognitivni,
  },
  "дорослим/антистресова-активність/дихальні-вправи": {
    name: "Дорослим/Антистресова активність/Дихальні вправи",
    component: Dinalni,
  },
  "дорослим/техніки-самодопомоги-тут-і-зараз/відчуваю-своє-тіло": {
    name: "Дорослим/Техніки самодопомоги тут і зараз/Відчуваю своє тіло",
    component: VidchuvaySvoeTilo,
  },
  "дорослим/техніки-самодопомоги-тут-і-зараз/техніка-«обійми-метелика»": {
    name: "Дорослим/Техніки самодопомоги тут і зараз/Техніка «Обійми метелика»",
    component: ObiymyMetelyka,
  },
  "дорослим/техніки-самодопомоги-тут-і-зараз/білатеральні-поплескування": {
    name: "Дорослим/Техніки самодопомоги тут і зараз/Білатеральні поплескування",
    component: BilateraPopleskuvannya,
  },
  "дорослим/техніки-самодопомоги-тут-і-зараз/тілесна-техніка-для-зниження-напруги": {
    name: "Дорослим/Техніки самодопомоги тут і зараз/Тілесна техніка для зниження напруги",
    component: Desensetyzatsiya,
  },
  "дорослим/техніки-самодопомоги-тут-і-зараз/дихальна-техніка-стабілізації": {
    name: "Дорослим/Техніки самодопомоги тут і зараз/Дихальна техніка стабілізації",
    component: Stabilizatsiya,
  },
  "дорослим/техніки-самодопомоги-тут-і-зараз/дихальна-техніка-«3-5-7»": {
    name: "Дорослим/Техніки самодопомоги тут і зараз/Дихальна техніка «3-5-7»",
    component: TryPyatSim,
  },
  "дорослим/техніки-самодопомоги-тут-і-зараз/заземлення-за-відчуттями-ніг": {
    name: "Дорослим/Техніки самодопомоги тут і зараз/Заземлення за відчуттями ніг",
    component: ZaVidchuttyamNih,
  },
  "дорослим/техніки-самодопомоги-тут-і-зараз/заземлення-в-положенні-лежачи": {
    name: "Дорослим/Техніки самодопомоги тут і зараз/Заземлення в положенні лежачи",
    component: VPolozhenniLezhachy,
  },
  "дорослим/техніки-самодопомоги-тут-і-зараз/заземлення-в-русі": {
    name: "Дорослим/Техніки самодопомоги тут і зараз/Заземлення в русі",
    component: VRusy,
  },
  "дорослим/техніки-самодопомоги-тут-і-зараз/заземлення-з-відтворенням-ритму": {
    name: "Дорослим/Техніки самодопомоги тут і зараз/Заземлення з відтворенням ритму",
    component: ZVidtvorennyamRytmu,
  },
  "дорослим/техніки-самодопомоги-тут-і-зараз/заземлення-через-активні-дії": {
    name: "Дорослим/Техніки самодопомоги тут і зараз/Заземлення через активні дії",
    component: CherezAktyvnyDiyi,
  },
  "дітям": {
    name: "Дітям",
    component: Dytyni,
  ...
  "дітям/мультфільми": {
    name: "Дітям/Мультфільми",
    component: Multfilmy,
  },
  "дітям/часті-запитання": {
    name: "Дітям/Часті запитання",
    component: Chasty,
  },
  "дітям/антистресова-активність-для-дітей": {
    name: "Дітям/Антистресова активність для дітей",
    component: Dity,
  },
  "дітям/антистресова-активність-для-підлітків": {
    name: "Дітям/Антистресова активність для підлітків",
    component: Pidlitky,
  },
  "контакти-служб-порятунку": {
    name: "Контакти служб порятунку",
    component: Kontakty,
  },
  "дії-в-надзвичайних-ситуаціях": {
    name: "Дії в надзвичайних ситуаціях",
    component: Diyi,
  },
  "дії-в-надзвичайних-ситуаціях/повітряна-тривога": {
    name: "Дії в надзвичайних ситуаціях/Повітряна тривога",
    component: Povitryana,
  },
  "дії-в-надзвичайних-ситуаціях/артилерійський-обстріл": {
    name: "Дії в надзвичайних ситуаціях/Артилерійський обстріл",
    component: Artyleriycky,
  },
  "дії-в-надзвичайних-ситуаціях/вимкнули-телебачення": {
    name: "Дії в надзвичайних ситуаціях/Вимкнули телебачення",
    component: Telebachennya,
  },
  "дії-в-надзвичайних-ситуаціях/застосування-хімічної-зброї": {
    name: "Дії в надзвичайних ситуаціях/Застосування хімічної зброї",
    component: Zastosuvannya,
  },
  "дії-в-надзвичайних-ситуаціях/евакуація": {
    name: "Дії в надзвичайних ситуаціях/Евакуація",
    component: Evakuatciya,
  },
  "дії-в-надзвичайних-ситуаціях/вибухонебезпечні-знахідки": {
    name: "Дії в надзвичайних ситуаціях/Вибухонебезпечні знахідки",
    component: VybuhonebezpechniZnahidky,
  },
  "дії-в-надзвичайних-ситуаціях/вибухонебезпечні-знахідки/вибухонебезпечні-предмети": {
    name: "Дії в надзвичайних ситуаціях/Вибухонебезпечні знахідки/Вибухонебезпечні предмети",
    component: VybuhonebezpechniPredmety,
  },
};