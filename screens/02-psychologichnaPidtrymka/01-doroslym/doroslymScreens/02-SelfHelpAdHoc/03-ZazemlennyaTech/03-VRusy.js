    ...
    <View>
      ...
      <ScrollView>
        <View style={styles.container}>
          ...
          <Bullet symbol="•" style={styles.paragraph}>Покачайте ногами, звертаючи увагу на відчуття того, як рухається кожна нога окремо.</Bullet>
          ...
          <Bullet symbol="•" style={styles.paragraph}>Виконайте те ж саме з пальцями рук, відчуваючи силу в м’язах, їх напругу й розслаблення під час виконання руху.</Bullet>
