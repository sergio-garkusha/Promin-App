    ...
    <View>
      ...
      <ScrollView>
        <View style={styles.container}>
          ...
          <Text style={styles.Subtitle}>Якщо вам потрібно зняти емоційний стрес, витратіть кілька хвилин, щоб зібратися, і обійміть себе. Робіть це до або під час надзвичайної ситуації, виконуйте ці вправи, щоб допомогти собі бути готовим.
          </Text>
          ...
          <Bullet symbol="•" style={styles.paragraph}>
            Помістіть праву руку долонею всередину під ліву пахву і ліву руку на плече, нижче плеча.
          </Bullet>
