    ...
    <View>
      ...
      <ScrollView>
        <View style={styles.container}>
          ...
          <Bullet symbol="•" style={styles.paragraph}>
            Ви дивитеся на стіну і розумієте, що подія, яку Ви хочете забути, це лише поодинока подія. Вона має свої межі, вона локальна і тепер займає лише мізерну частину Вашої стіни життя. Це чорно-біле фото - це не Ваше життя.
          </Bullet>
          <Bullet symbol="•" style={styles.paragraph}>
