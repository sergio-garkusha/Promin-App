    ...
    <View>
      ...
      <ScrollView>
        <View style={styles.container}>
          <Text style={styles.header}>Техніка білатеральної стабілізації “Обійми метелика”</Text>
          ...
          <Bullet symbol="•" style={styles.paragraph}>Покладіть праву долоню на ліве плече та «навхрест» ліву долоню на праве плече (послідовність можна змінити та міняти як найзручніше)</Bullet>
