      ...
      <ScrollView>
        <View style={styles.container}>
          ...
          <Paragraph style={{ paddingBottom: 20 }}>
            ...
            Для найменших його може забезпечити тілесний контакт. Старайтеся говорити якомога простіше. Чим менша за віком дитина,
            тим простіші та коротші слова та речення використовуйте.  Відповідайте лише на ті питання, які ставить дитина. Старайтеся говорити правду. Дозовано, спираючись на факти, що викликають позитив та надію на майбутнє.
          </Paragraph>

          <Accordion title="«Навіщо нам їхати з дому?»">
            <Text style={styles.paragraph}>
              «Ми їдемо, щоб опинитися далеко-далеко від небезпеки. Подорож може бути
              нелегкою. Зрештою ми повернемось (або в нас буде новий дім, більший та кращій)».
            </Text>
            <Text style={styles.paragraph}>
            ...
            <Text style={styles.paragraph}>
              ...
              Переїзд, особливо раптовий, може викликати сильні переживання.
            </Text>
          </Accordion>
          ...
          <Accordion title="«Ми можемо вмерти?»">
            <Text style={styles.paragraph}>
              «Наша армія нас захищає. Воїни багато тренувалися, і вони знають як боронити нашу країну. Вони роблять все, аби ми були в безпеці».
            </Text>
          </Accordion>
          ...
          <Accordion title="«Мій тато теж загине?»">
            <Text style={styles.paragraph}>
              ...
              чия робота – захищати одне одного. Ми сподіваємось, що він вже скоро повернеться. Але зараз тато має справи».
            </Text>
            <Text style={styles.paragraph}>
