    ...
    <View>
      ...
      <ScrollView>
        <View style={styles.container}>
          ...
          <Paragraph>
            Для проживання цього непростого періоду кожній людині потрібна підтримка. Підліткам це теж дуже важливо.
            Вони можуть цього не визнавати, або демонструвати невизнання, та батькам тут важливо бути уважними.
          </Paragraph>
          <Paragraph>
            Підліткам дуже важливо відчувати себе прийнятими на рівні з дорослими.
            ...
            “дорослої” інформації та діяльності.
          </Paragraph>
          ...
          <Accordion title="Антистресова ментальна активність">
            ...
            <Bullet symbol="•" style={styles.paragraph}>
              Чому говорити неправду це погано - говорять правильні слова, а роблять по іншому
            </Bullet>
            <Bullet symbol="•" style={styles.paragraph}>
            ...
            <Bullet symbol="•" style={styles.paragraph}>
              Бути добрим - не значить не захищатись
            </Bullet>
            <Bullet symbol="•" style={styles.paragraph}>
            ...
            <Bullet symbol="•" style={styles.paragraph}>
              Задавайте запитання підліткам, питайте їхню думку
            </Bullet>
            <Bullet symbol="•" style={styles.paragraph}>
          ...
          <Accordion title="Антистресова поведінкова активність">
            ...
            <Bullet symbol="•" style={styles.paragraph}>
              Знайти  грані камінці, можна вкласти їх в взуття, щоб краще їх відчувати та відволікатися від важких думок;
            </Bullet>
            <Bullet symbol="•" style={styles.paragraph}>
              Цукерки різних смаків (солоні, гіркі, кислі, солодкі);
            </Bullet>
            <Bullet symbol="•" style={styles.paragraph}>
              М’ячик-їжачок в руці, як засіб для відволікання від нав’язливих думок. Його можна перекочувати по руці, порахувати точки від нього на шкірі;
            </Bullet>
            <Bullet symbol="•" style={styles.paragraph}>
              Щоденник фото, буде чудово, якщо з описом настрою;
            </Bullet>
            <Bullet symbol="•" style={styles.paragraph}>
            ...
            <Bullet symbol="•" style={styles.paragraph}>
              ...
              замість того щоб помовчати – поспівай;
            </Bullet>
            <Bullet symbol="•" style={styles.paragraph}>
              Вправи на уважність;
            </Bullet>
            ...
            <Bullet symbol="•" style={styles.paragraph}>
              Зав’язувати та зав’язувати різні вузли;
            </Bullet>
            <Bullet symbol="•" style={styles.paragraph}>
              Орігамі;
            </Bullet>
          ...
          <Accordion title="Вправа “Барабани без барабана”">
            <Paragraph>
              Це гарна вправа на зосередженність, яка фокусує вашу увагу на вашому чутті слуху, на руках рук і,
              звичайно, як і у випадку з багатьма іншими вправами, ви можете її трохи модифікувати та виконувати на самоті.
            </Paragraph>
            <Paragraph>
              Вправа досить проста і не вимагає наявності барабана, адже її можна виконувати на столі, стегнах,
              тупаючись по підлозі або будь-якій іншій поверхні.
            </Paragraph>
            <Paragraph>
            ...
            <Paragraph>
              Тепер група має знайти спільний ритм, аж поки хтось не спробує встановити новий ритм або змінити гучність,
              а група спробує до нього долучитися.
            </Paragraph>
            <Paragraph>
              Для гри на барабанах можна використовувати будь-які поверхні,
              постукувати по стегнах, ногами по підлозі. У вас можуть виникнути зовсім інші та нові ідеї.
            </Paragraph>
          </Accordion>
