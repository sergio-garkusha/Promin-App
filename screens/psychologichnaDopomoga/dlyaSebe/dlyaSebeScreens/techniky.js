      ...
      <ScrollView>
        <View style={styles.container}>
          <View style={{ padding: 20 }}>
            ...
            <ListItem roundTop title="Відчуваю своє тіло" onPress={navigateAway} />
            <ListItem title="Техніка білатеральної стабілізації “Обійми метелика” " onPress={navigateAway} />
            <ListItem title="Техніка білатеральної стабілізації – білатеральні поплескування"onPress={navigateAway}/>
            <ListItem roundBottom title="Тілесна техніка “Десенситизація”" onPress={navigateAway}/>

            <Text style={styles.title}>Дихальні техніки</Text>

            <ListItem title="Дихальна техніка стабілізації"onPress={navigateAway}/>
            <ListItem roundBottom title="Дихальна техніка “3-5-7”" onPress={navigateAway}/>

            <Text style={styles.title}>Техніки заземлення</Text>

            <ListItem roundTop title="Техніка заземлення за відчуттями ніг" onPress={navigateAway} />
            <ListItem title="Техніка заземлення в положенні лежачи" onPress={navigateAway} />
            <ListItem title="Техніка заземлення в русі"onPress={navigateAway}/>
            <ListItem roundBottom title="Техніка заземлення з відтворенням ритму" onPress={navigateAway}/>
            <ListItem roundBottom title="Техніка заземлення через активні дії" onPress={navigateAway}/>
