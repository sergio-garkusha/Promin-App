        ...
        <View>
            ...
            <ScrollView>
                <View style={styles.container}>
                    ...
                    <Bullet symbol='2.' style={styles.paragraph}>Кінчиками великого та вказівного пальців массуйте постраждалій точки,
                    ...
                    <Bullet symbol='3.' style={styles.paragraph}>Долоню вільної руки покладіть на грудну клітину постраждалої.
                        Підлаштуйте ритм свого дихання під дихання постраждалої. </Bullet>

                    <Bullet symbol='4.' style={styles.paragraph}>Людина що знаходиться в ступорі, може чути і бачити. Тому говоріть їй
