      ...
      <ScrollView>
        <View style={styles.container}>
          ...
          <Paragraph style={{ paddingBottom: 20 }}>
            Один із найбільш небезпечних видів вогневого враження під час воєнних
          ...
          <Accordion title="Обстріл застав вас на вулиці">
            <Paragraph>
              ...
              конструкції та накрийте голову руками.
            </Paragraph>
            <Paragraph>
              ...
              після підриву летять на висоті 30-50 см. над поверхнею землі.
            </Paragraph>
          </Accordion>

          <Accordion title="Обстріл застав вас в будівлі">
            <Paragraph>
              Негайно спускайтесь у підвал, у випадку якщо підвал відсутній, або
              зачинений зайдіть до сусідів на першому поверсі. Існує правило: чим нижче  тим безпечніше. Як правило
              снаряди попадають у верхні поверхи.
            </Paragraph>
            <Paragraph>
              Якщо артилерійський обстріл застав вас у будинку зненацька і не
              залишилося часу зреагувати, швидко йдіть в кімнату віддалену від напряму обстрілу.
            </Paragraph>
            <Paragraph>
          ...
          <Accordion title="Обстріл застав вас в транспорті">
            ...
            <Paragraph>
              Загальні вимоги до укриття. Воно має бути заглибленим і разом із тим
          ...
          <Accordion title="Сховатись під час артобстрілу можна">
          ...
          <Accordion title="Після закінчення артобстрілу">
            <Paragraph>Зачекайте приблизно 10хв.</Paragraph>
            <Paragraph>
            ...
            <Paragraph>
              Не піднімайте з землі незнайомі вам предмети.
            </Paragraph>
            <Paragraph>
              ...
              вибухнути від найменшого дотику.
            </Paragraph>
            <Paragraph>
