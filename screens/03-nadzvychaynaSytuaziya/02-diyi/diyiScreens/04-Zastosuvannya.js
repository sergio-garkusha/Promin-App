        ...
        <View style={styles.container}>
          ...
          <Accordion title="Якщо відчуваєте симптоми ураження">
            ...
            <Bullet symbol="•" style={styles.paragraph}>
              ...
              подразливих речовин - наприклад, почервоніння, свербіж та печіння очей або шкіри - промийте їх водою.
            </Bullet>
            <Bullet symbol="•" style={styles.paragraph}>
              Не використовуйте мило для промивання очей. Не торкайтеся
              інших людей, щоб уникнути можливого поширення хімікату.
            </Bullet>
          </Accordion>
          ...
          <Accordion title="Надворі">
            ...
            <Bullet symbol="•" style={styles.paragraph}>
              Намашайтесь рухатись швидко, але не бігти
            </Bullet>
            <Bullet symbol="•" style={styles.paragraph}>
          ...
          <Accordion title="В приміщенні">
            <Bullet symbol="•" style={styles.paragraph}>
              Підніміться на найвищий поверх та знайдіть кімнату з якомога
              меншою кількістю вікон та дверей
            </Bullet>
            <Bullet symbol="•" style={styles.paragraph}>
          ...
          <Accordion title="В автомобілі">
            <Bullet symbol="•" style={styles.paragraph}>
              Зʼїжджайте на узбіччя, не заважайте руху аварійних
              автомобілів
            </Bullet>
            <Bullet symbol="•" style={styles.paragraph}>
              Вимкніть двигун і закрийте всі вентиляційні отвори,
              які втягують зовнішнє повітря, включаючи вентиляційні отвори кондиціонера.
            </Bullet>
            <Bullet symbol="•" style={styles.paragraph}>
              Прикрийте рот і ніс тканиною: шарфом, хустинкою чи маскою
              для обличчя.
            </Bullet>
          </Accordion>
