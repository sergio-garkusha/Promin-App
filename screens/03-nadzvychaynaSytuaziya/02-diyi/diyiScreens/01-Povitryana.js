        ...
        <View style={styles.container}>
          ...
          <Accordion title="Якщо ви вдома:">
            ...
            <Bullet symbol="5." style={styles.paragraph}>
              ...
              із внутрішньої боку одягу у дітей дошкільного віку нашивок на яких зазначено: прізвище, ім’я, по-батькові, адреса, вік, номер домашнього телефону.
            </Bullet>
          ...
          <Accordion title="Якщо ви на роботі:">
            <Bullet symbol="1." style={styles.paragraph}>
              ...
              суб’єктами господарювання , Інструкція щодо дій персоналу суб’єкта господарювання у разі загрози або виникнення надзвичайних ситуацій.
            </Bullet>
            <Bullet symbol="2." style={styles.paragraph}>
          ...
          <Accordion title="Якщо ви в транспорті:">
            <Bullet symbol="1." style={styles.paragraph}>
              Попросіть водія зупинити транспортний засіб. У разі відсутності в
              ...
              Внаслідок вибуху вони будуть руйнуватися від впливу ударної хвилі.
            </Bullet>
            <Bullet symbol="2." style={styles.paragraph}>
